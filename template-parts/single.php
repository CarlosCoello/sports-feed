...
<div class="container single-post before-load-posts">
  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      ...
      <div class="sports-feed-share-it">
           ...
           <ul>
              <li>
                <a href="<?php echo $twitter; ?>" target="_blank" rel="nofollow">
                  <span class="dashicons dashicons-twitter"></spa>
                </a>
              </li>
              <li>
                <a href="<?php echo $facebook; ?>" target="_blank" rel="nofollow">
                  <span class="dashicons dashicons-facebook"></spa>
                </a>
              </li>
           </ul>
           
      </div><!-- .sports-feed-share-it -->

      <footer class="entry-footer">
          <p><?php the_tags(); ?></p>
          <?php echo sports_feed_post_navigation(); ?>
      </footer><!-- .entry-footer -->
